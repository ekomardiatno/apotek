...
class PrintController extends Controller {
    public function index() {
        ...
        $sql = "SELECT a.tanggal, a.nik, b.nama, b.alamat, b.jenis_kelamin, b.norm, a.tanggal_kembali FROM konsul a LEFT JOIN pasien b ON b.nik=a.nik WHERE a.tanggal >= '". $post['start'] ."' AND a.tanggal <= '". $post['end'] ."' ORDER BY a.tanggal OR b.nama ASC";
        $data = $db->query($sql);
